...
public class Lesson3enViewModel : oostfraeiskorg.ViewModels.MasterPageViewModel
{
    ...
    {
        MasterPageTitle = "lesson 3 - Ōstfräisk Wōrdenbauk - East Frisian Dictionary";
        ...
        MasterPageKeywords += ", lesson 3, eastfrisian language, eastfrisian, ōstfräisk, course, course of eastfrisian language";
        return base.Init();
    }
}
