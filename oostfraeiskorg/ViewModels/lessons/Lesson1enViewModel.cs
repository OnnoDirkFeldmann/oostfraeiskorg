...
namespace oostfraeiskorg.ViewModels.lessons
{
    public class Lesson1enViewModel : oostfraeiskorg.ViewModels.MasterPageViewModel
    {
        ...
        {
            MasterPageTitle = "lesson 1 - Ōstfräisk Wōrdenbauk - East Frisian Dictionary";
            ...
            MasterPageKeywords += ", lesson 1, eastfrisian language, eastfrisian, ōstfräisk, course, course of eastfrisian language";
            return base.Init();
        }
    }
}
