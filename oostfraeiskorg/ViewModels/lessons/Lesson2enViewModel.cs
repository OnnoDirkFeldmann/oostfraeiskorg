...
public class Lesson2enViewModel : oostfraeiskorg.ViewModels.MasterPageViewModel
{
    ...
    {
        MasterPageTitle = "lesson 2 - Ōstfräisk Wōrdenbauk - East Frisian Dictionary";
        ...
        MasterPageKeywords += ", lesson 2, eastfrisian language, eastfrisian, ōstfräisk, course, course of eastfrisian language";
        return base.Init();
    }
}
