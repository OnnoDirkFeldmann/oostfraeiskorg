...
public class Lesson4enViewModel : oostfraeiskorg.ViewModels.MasterPageViewModel
{
    ...
    {
        MasterPageTitle = "lesson 4 - Oostfräisk Woordenbauk - East Frisian Dictionary";
        ...
        MasterPageKeywords += ", lesson 4, eastfrisian language, eastfrisian, oostfräisk, course, course of eastfrisian language";
        return base.Init();
    }
}
